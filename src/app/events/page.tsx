  ...
  return (
    <>
      ...
      <p className={shared.mutedText} style={{ marginBottom: 20 }}>
        collector가 매일 08:30 판매처(티켓타코·이벤터스)와 Dev-Event(해커톤)에서 모은 행사가 &lsquo;검토를 기다리는 행사&rsquo;에 쌓여요.
        티켓타코·Dev-Event 행사는 모을 때 공식 사이트 이미지를 미리 찾아 두고, &lsquo;올리기&rsquo;를 누르면 그 이미지를 채워 보여 줘요.
